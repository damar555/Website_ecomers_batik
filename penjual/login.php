...
if (empty($userName)) {
    ...
    echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";
        ...
        $login = mysqli_query($koneksi, "SELECT * FROM tbl_penjual WHERE username='$userName' AND password = '$password'");
...
if ($ketemu >0) {
    ...
    $_SESSION['idPenjual'] = $r['id_penjual'];
    header('location:penjualweb.php?module=home');
}else{
    echo "<center><script> alert('LOGIN GAGAL!')</script>";
    echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<br>";
    echo "<br>";echo "<br>";echo "<br>";echo "<br>";echo "<b>LOGIN GAGAL!</b><br>";
