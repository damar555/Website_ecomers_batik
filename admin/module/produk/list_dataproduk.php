                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="adminweb.php?module=tambah_produk" class="btn btn-primary">Tambah Produk<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive table-invoice">
                            <table class="table table-striped">
                                ...
                                $kueriProduk = mysqli_query($koneksi, "SELECT p.id_produk AS idProduk, p.nama_produk AS namaProduk, k.nama_kategori AS namaKategori, j.nama_penjual AS namaPenjual, p.gambar AS Gambar, p.harga AS Harga, p.deskripsi AS deskripsi, p.slide AS slide FROM produk p, kategori k, tbl_penjual j WHERE p.id_produk = p.id_produk AND k.id_kategori = p.id_kategori AND p.id_penjual = j.id_penjual");
