                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                $invoice = $row['invoice'];
                                                $QueryItems = mysqli_query($koneksi, "SELECT  status_order FROM tbl_detail_order do INNER JOIN tbl_order o ON do.id_order = o.id_order INNER JOIN produk p ON o.id_produk = p.id_produk WHERE do.invoice = '$invoice'");;
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                <a href="<?= $admin_url; ?>adminweb.php?module=edit_pesanan&invoice=<?= $row['invoice']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
